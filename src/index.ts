...
async function main() {
  ...
  // Only set up command-line interface and HTTP server when monitoring is enabled
  // (stdin conflicts with MCP stdio transport, HTTP server causes EADDRINUSE on restart)
  if (config.monitoring?.enabled) {
